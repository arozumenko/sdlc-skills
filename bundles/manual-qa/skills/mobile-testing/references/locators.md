...
## Device Farm Mode — Mobitru MCP

Mobitru does not expose `generate_locators`. Use `mobile_list_elements_on_screen` to enumerate visible elements, then reference them by:
