// normalize.mjs — text normalisation shared by `gate`, `cite` and `coverage`
// (TASK-003, US-002 AC-5; spec §6.2 "normalisation rules").
//
// Finding identity hashes the *normalised* snippet, so these rules are part of
// the identity contract. The published vectors in
// ../references/normalize-vectors.json are the reference; normalize.test.mjs
// replays every one of them. Change a rule ⇒ republish the vectors.
//
...
//
// Leaf module: stdlib only, no I/O, no clock (G-1), no other scripts/ import.
