...
const COMMANDS = {
  engagement: () => import("./lib/cmd-engagement.mjs"), // TASK-008 (init, validate) / TASK-010 (baseline)
  ...
  // gate: () => import("./lib/cmd-gate.mjs"),               // TASK-019
  coverage: () => import("./lib/cmd-coverage.mjs"), // TASK-020
  packet: () => import("./lib/cmd-packet.mjs"), // TASK-057 (core + --kind scope) / TASK-021 (--kind subject)
