...
skills: [test-automation-workflow, memory, issue-tracking, verification-before-completion, completing-a-task, git-workflow]
skills-on-demand: [code-review, subagent-driven-development, dispatching-parallel-agents]
metadata:
  authors:
