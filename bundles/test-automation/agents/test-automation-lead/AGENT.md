...
skills-on-demand: [code-review, subagent-driven-development, dispatching-parallel-agents, issue-tracking, verification-before-completion, completing-a-task, git-workflow, delivery-metrics]
metadata:
  authors:
