...
| `qaspace` | Query the EPAM qaspace Test Management Plugin in a Jira Server / Data Center instance — test runs, folder trees, status/type triage. JQL via REST API v2 or an MCP-wired Jira connector. Stdlib Python folder-tree parser |
