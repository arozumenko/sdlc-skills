...
test('renderHtml: human sections — campaign header, KPI cards, per-task bar rows in natural units', () => {
  ...
  assert.match(html2, /<details class="mission" open><summary><div class="mrow mission"><div class="c ref"><span title="sec\/run-1\/mission-g2">G2<\/span><\/div><div class="c "><span class="oc oc-in_progress">in progress<\/span><\/div>.*?<div class="c num">1\/2<\/div>/, 'open mission shows done/in-scope from current_scope.child_summary');
