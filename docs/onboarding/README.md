...
|---|---|---|
| [**feature-development**](feature-development.md) | `--bundle feature-development` | A cross-platform delivery team — BA, PM, tech-lead, QA, scout, and pickable dev roles (Python / JS / iOS / greenfield-Compose Android / test-automation). You're building features. |
