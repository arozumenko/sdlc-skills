...
function fixture() {
  ...
  mkdirSync(join(root, "bundles/alpha"), { recursive: true }); writeFileSync(join(root, "bundles/alpha/factory.json"), "{}");
  mkdirSync(join(root, "bundles/beta"), { recursive: true }); writeFileSync(join(root, "bundles/beta/factory.json"), "{}");
